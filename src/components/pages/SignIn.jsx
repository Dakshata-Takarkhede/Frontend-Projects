    ...
    <div className="flex items-center justify-center bg-white px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
      <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
        ...
        <p className="mt-2text-sm text-gray-600">
          ...
          <a href="#" title="" className="font-semibold text-black transition-all duration-200 hover:underline"> Create a free account </a>
        </p>
        <form action="#" method="POST" className="mt-8" id="">
          <div className="space-y-5">
            ...
            <div>
              <button type="button" className="inline-flex w-full items-center justify-center rounded-md bg-yellow-500 px-3.5 py-2.5 text-xl font-semibold leading-7 text-white hover:bg-yellow-400">
                Get started
